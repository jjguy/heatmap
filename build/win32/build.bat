...
"%VCINSTALLDIR%\bin\cl.exe" /c /Zi /nologo /W3 /WX- /O2 /Oi /Oy- /GL /D WIN32 /D NDEBUG /D _WINDOWS /D _USRDLL /D HEATMAP_EXPORTS /D _WINDLL /D _UNICODE /D UNICODE /Gm- /EHsc /MD /GS /Gy /fp:precise /Zc:wchar_t /Zc:forScope /Fo"x86\\" /Fd"x86\VC110.PDB" /Gd /TC /analyze- ..\..\HEATMAP.C
...
"%VCINSTALLDIR%\bin\x86_amd64\cl.exe" /c /Zi /nologo /W3 /WX- /O2 /Oi /GL /D WIN32 /D NDEBUG /D _WINDOWS /D _USRDLL /D HEATMAP_EXPORTS /D _WINDLL /D _UNICODE /D UNICODE /Gm- /EHsc /MD /GS /Gy /fp:precise /Zc:wchar_t /Zc:forScope /Fo"X64\\" /Fd"X64\VC110.PDB" /Gd /TC ..\..\HEATMAP.C
@if not ERRORLEVEL 0 goto bad
